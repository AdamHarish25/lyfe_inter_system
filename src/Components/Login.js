...
export default function Login() {
    ...
    return <div className="w-screen overflow-x-hidden overflow-y-auto lg:overflow-y-hidden h-auto lg:h-screen block lg:grid grid-cols-2">
        <div className="w-full h-screen grid place-items-center bg-LivingRoom bg-cover bg-center lg:bg-none">
            <div className="sm:w-80 md:w-96 lg:w-100 xl:w-110 bg-[#F6EFE9] py-20 px-10">
                ...
                <form className="space-y-7 grid place-items-center py-5">
                    ...
                    <div className="w-64 h-auto">
                        ...
                        <div className="flex border border-gray-300 w-full px-2">
                            ...
                            {!isClicked ? (
                                <button title="Reveal Password" id="eye" className="p-2 rounded-full hover:bg-gray-500/[.30] transform duration-300" type={"button"} onClick={() => setClicked(!isClicked)}>
                                ...
                                <button title="Unreveal Password" id="eyeSlash" className="p-2 rounded-full hover:bg-gray-500/[.30] transform duration-300" type={"button"} onClick={() => setClicked(!isClicked)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
